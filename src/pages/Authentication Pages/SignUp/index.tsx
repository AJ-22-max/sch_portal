...
function SignUp() {
    ...
    const validateStep = (step: number): boolean => {
        switch (step) {
            ...
            case 1: {
                if (!formData.email || !formData.phone || !formData.country || !formData.address) {
                    setError("Please fill in all required fields");
                    return false;
                }
                ...
                if (formData.website && formData.website.trim() !== "") {
                    ...
                    if (!urlRegex.test(formData.website)) {
                        setError("Website must be a valid URL (e.g., https://yourschool.com)");
                        return false;
                    }
                }
                break;
                ...
                <Container maxWidth="md">
                    <Box sx={styles.successBox}>
                        ...
                        <Typography sx={styles.modalDescription}>
                            Thank you for your interest in SchoolPortal. Our team will review your application and contact you via email within 24-48 business hours with your account credentials.
                        </Typography>
                ...
                return (
                    <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", mb: 3 }}>
                            ...
                            />
                            <Typography variant="body2" color="base.customDark" sx={{ opacity: 0.7 }}>
                    ...
                    <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                        ...
                        >
                            ...
                            <Box
                                ...
                                style={{ display: "none" }}
                                onChange={(e) => handleFileUpload("cert_incorporation", e.target.files?.[0] ?? null)}
                            />
                        </Box>
    ...
    return (
        <Box sx={{ minHeight: "100vh" }}>
            <Grid container sx={{ minHeight: { xs: "100vh", md: 'auto', lg: '100vh' }, p: 1.5 }}>
                        ...
                        <Box sx={styles.steps}>
                            {stepsData.map((item, index, array) => (
                                <Box key={index}>
                                    <Box sx={{
                                        ...styles.step,
                                        transform: activeStep === item.step ? 'translateX(8px)' : 'translateX(0)',
                                    }}>
                                        <Box sx={{
                                            position: 'relative',
                                            display: 'flex',
                                            ...
                                            <Box sx={{
                                                ...
                                                height: 44,
                                                borderRadius: '12px',
                                                background: activeStep === item.step
                                                ...
                                                boxShadow: activeStep === item.step
                                        ...
                                        <Box sx={{
                                            pt: 1, flex: 1, bgcolor: activeStep === item.step ? 'rgba(255, 255, 255, 0.25)' : 'transparent',
                                            backdropFilter: activeStep === item.step ? 'blur(10px)' : 'none',
                                            border: activeStep === item.step ? '1px solid rgba(255, 255, 255, 0.1)' : '2px solid transparent',
                                            transform: activeStep === item.step ? 'translateX(8px) scale(1.02)' : 'translateX(0)',
                                            boxShadow: activeStep === item.step ? '0 8px 24px rgba(0,0,0,0.15)' : 'none',
                                            px: 2, py: 2, borderRadius: '8px'
                                        }}>
                                            <Typography
                                                sx={{
                                                    fontWeight: activeStep === item.step ? 700 : 600,
                                                    fontSize: '15px',
                                                    color: activeStep === item.step ? '#0f172a' : '#64748b',
                                                    mb: 0.75,
                                                    letterSpacing: '-0.2px',
                                            ...
                                            <Typography
                                                sx={{
                                                    fontSize: '13px',
                                                    color: activeStep === item.step ? '#6b7280' : '#9ca3af',
                                                    lineHeight: 1.6,
                                                    transition: 'color 0.3s'
                                                }}
                                            >
                ...
                <Grid
                    ...
                    sx={styles.rightGrid}
                >
                    <Container maxWidth="xl" sx={{ py: { xs: 3, md: 0 }, mx: { md: 8, lg: 15 } }}>
                        {/* Mobile Logo */}
                        <Box sx={styles.mobileLogoBox}>
                            <Box component="img" src="/logo/favicon.png" alt="Logo" sx={{ width: { xs: '36px', sm: '50px', lg: '36px' } }} />
                                        ...
                                        >
                                            <Box sx={{
                                                ...
                                                <Box sx={{
                                                    ...
                                                    {activeStep > index ? <CheckCircle sx={{ fontSize: { xs: 18, sm: 20 } }} /> : index + 1}
                                                </Box>
                                                <Typography
                                                    sx={{
